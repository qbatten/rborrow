...
grammar = r'''_title: "[" ptype  _spacing r_amt _spacing r_loc _spacing  r_gen  _spacing ( r_type ( _spacing? r_misc? ( ")" | "]" )? )? )?
        ...
        _w_gobbler: /[0-9A-Za-z!\/\s\$'?,.&;-]+/
            ...
            dword: mon ( _SPACERS | "/" )? day ( _SPACERS | "/" )? yr?
              ...
              mon: dm_num | dm_word
          dm_num: /[0-9][0-2]?/
          dm_word: "Jan" | "Feb" | "Mar" | "Apr" | "May" | "Jun" | "Jul"
                        | "Aug" | "Sept" | "Nov" | "Dec"
                 | "January" | "February" | "March" | "April" | "May" | "June"
              uuuuuuu          | "July" | "August" | "September" | "November"
                        | "December"
         ...
         user_bad: "u/" /[A-Za-z0-9_\-]+/
           ...
           _cash: cashgood | cash_bad
           cashgood.2: (_MONEY INT) | (INT _MONEY)
        cash_bad: /[$£€]/? INT /[€\.-]/? ( /[A-Za-z\-\/]+/ | /[$£]/? /[0-9\.-]+/ )*
